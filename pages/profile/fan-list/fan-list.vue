<template>
	<view class="page-container" :data-theme="theme">
		<u-navbar title="粉丝列表" bgColor="var(--bg-color)" autoBack placeholder></u-navbar>
...
<script>
	import {getFanPage} from '@/api/follow.js'
	export default {
		data() {
			return {
				dataList: [],
		...
		methods: {
			async nextPage() {
				...
				let res = await getFanPage(this.targetUserid,body)
